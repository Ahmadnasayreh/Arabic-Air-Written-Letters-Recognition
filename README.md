  Hybrid Model Development: Created a hybrid model combining deep learning (VGG16, VGG19, SqueezeNet) with machine learning (NN, RF, KNN, SVM), achieving 88% accuracy using VGG16 and NN.
